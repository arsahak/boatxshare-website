                            ...
                            <div key={review.id} className="flex gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    {/* <div className="flex items-center gap-4 mb-1">
                                        <div className="w-16 h-[60px] !rounded-full">
                                            <Image src={review?.image} alt="image" height={200} width={200} className="h-full w-full rounded-full" />
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex items-center gap-4 mb-1">
                                        {review.image ? (
                                            ...
                                            <div
                                                className={`w-16 h-[60px] rounded-full ${review.avatarColor} flex items-center justify-center font-medium`}
                                            >
                                    ...
                                    <div className="flex mb-2">
                                        {[...Array(5)].map((_, i) => (
                                            <BiStar
                                                key={i}
                                                className={`w-4 h-4 ${i < review.rating ? 'text-gray-400 fill-current' : 'text-gray-200'
                                                    }`}
                                            />
                                        ))}
                                    </div>

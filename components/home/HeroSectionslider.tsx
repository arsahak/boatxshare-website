...
const HeroSectionslider = () => {
  ...
  return (
    ...
    //         </div>
    //         <div>
    //           <div className="absolute bg-white left-52 rounded-[20px] p-10 z-50 shadow-lg w-full max-w-4xl mx-auto">
    ...
    //               <button className="bg-[#00C2FF] text-white px-8 py-1 -mb-16 rounded-md hover:bg-[#00B2FF] transition">
    //                 Search
    //               </button>
    //             </div>
    //           </div>
